...
I have created a subset of the data called `FootballPlayers`, excluding the control group
...
```{r Q3a, echo=FALSE}
question("Which of the following interpretations of the summary are correct?",
  answer("The expected value of hippocampus volume for football players with no concussion is 452 microL lower than that for players with concussion",message="This is missing something! 'for same number of years playing time'"),
  answer("We would expect someone with no years of playing experience to have a hippocampus size of 6867.34 microL",
         message="This is missing something! 'With a concussion injury' since concussion injury is the reference group. It probably does not make sense to interpet the intercept in this way"),
  answer("For every year increase in playing time we expect to see a reduction of size of 86.34 microL within both groups",correct=TRUE),
...
question("Which of the following interpretations of the residual plots are appropriate?",
  answer("Observations from rows 25 and 50 are outliers and should be removed",message="Rows 25 and 50 are minor outliers, but they do not appear to be huge outliers; certainly not enough to consider removal"),
  answer("The points from the Normal Q-Q plot do not all fall on the line. So we cannot assume an underlying normal distribution",
  ...
  answer("There is no trend in the 'Residuals vs Fitted' Plot, therefore linearity seems an appropriate assumption",correct=TRUE),
  answer("There is some evidence of an increase in variability with an increase in the fitted values, but this seems to be driven by just two observations which were predicted extremely well",correct=TRUE),allow_retry = TRUE,random_answer_order = TRUE
)
```
